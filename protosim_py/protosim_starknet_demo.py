...
def test_starknet_swap_simulation():
    ...
    sell_token_contract_override = StarknetContractOverride(
        token0,
        "0x02760f25d5a4fb2bdde5f561fd0b44a3dee78c28903577d37d669939d97036a0",
        None,
    )
    ...
    storage_overrides = {
        token0: {
            int(
                "2039938672845109684464553252816414832543773106309397125013760479565072283554"
            ): int("25609114925068689"),
            int(
                "1919009528300487416898558168639787817852314761514939568475739027942176236393"
            ): int("2421600066015287788594"),
        }
    }
    params = StarknetSimulationParameters(
        caller=test_wallet,
