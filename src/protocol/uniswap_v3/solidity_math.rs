...
pub fn mul_div_rounding_up(a: U256, b: U256, denom: U256) -> Result<U256, NativeSimulationError> {
...
pub fn mul_div(a: U256, b: U256, denom: U256) -> Result<U256, NativeSimulationError> {
    let a_big = U512::from(a);
    let b_big = U512::from(b);
    let product = safe_mul_u512(a_big, b_big)?;
